...
namespace InformedProteomics.Backend.TopDownScoring
{
    public class TopDownScorer //TODO consider binning .... 
    {
        ...
        private readonly DataDependentAcquisitionRun _run;
        ...
        public TopDownScorer(Composition proteinComposition, DataDependentAcquisitionRun run, Tolerance tolernace, SubScoreFactory factory)
        {
            _run = run;
        ...
        private bool filterXic(double[][] truncatedXics1, double[][] truncatedXics2)
        {
            ...
            var corr = StatisticsTools.GetCorrelation(abundantXic1, abundantXic2);
        ...
        private int GetIsotopeCorrelationIntegerRawScore(double[][] truncatedXics)
        {
            ...
            for (var k = 0; k < truncatedXics.Length; k++)
            {
                ...
                {
                    var corr = StatisticsTools.GetCorrelation(abundantXic, truncatedXics[k]);
            ...
            var isotopeCorr = StatisticsTools.GetCorrelation(isotopePeaks, _isotopeEnvelope);
