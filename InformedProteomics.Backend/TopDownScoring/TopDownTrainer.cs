...
namespace InformedProteomics.Backend.TopDownScoring
{
    class TopDownTrainer
    {
        ...
        private DataDependentAcquisitionRun _run;
        private Tolerance _tolerance;

        public void Train(string outFileName, DataDependentAcquisitionRun run, Tolerance tolerance, string annotationFileName)
        {
