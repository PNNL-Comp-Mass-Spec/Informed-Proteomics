...
{
    public class Ms1FeatureQuntify: Ms1FeatureMatrix
    {
        public const string QuantFileExtension = "quant.ms1ft";
        
        public Ms1FeatureQuntify(LcMsRun run, int minScanCharge = 2, int maxScanCharge = 60, int maxThreadCount = 0, int numBits = 27)
            : base(run, minScanCharge, maxScanCharge, maxThreadCount, numBits)
        {
